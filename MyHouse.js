...
class MyHouse extends CGFobject {
    ...
    initMaterials(){
        ...
        this.wallTex.setAmbient(0.5, 0.5, 0.5, 1);
        ...
        this.fenceTex.setAmbient(0.5, 0.5, 0.5, 1);
        ...
        this.roofTex.setAmbient(0.5, 0.5, 0.5, 1);
        ...
        this.marbleTex.setAmbient(0.5, 0.5, 0.5, 1);
        this.marbleTex.setDiffuse(0.5, 0.5, 0.5, 1);
